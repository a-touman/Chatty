...
public class ChatFragment extends Fragment {
    ...
    FirestoreRecyclerAdapter<FirebaseModel, NoteViewHolder2> adapter ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       ImageView moreDots = (ImageView) view.findViewById(R.id.chatfragmentmore_id);
        ...
        //message icon in bottom bar
        ImageView icon = (ImageView) view.findViewById(R.id.chatfragmenticon_id);
        ...
        chatRecyclerView = view.findViewById(R.id.chatfragmentRecyclerView_id);
        ...
        Query query = firebaseFirestore.collection("Users") // if we stop here it gets all users in database
                ...
                .whereEqualTo("texted","YES"); //here we only get the contacts that we texted before to place them in the chats fragment
        ...
        adapter = new FirestoreRecyclerAdapter<FirebaseModel, ChatFragment.NoteViewHolder2>(allusernames) {
            @Override
            protected void onBindViewHolder(@NonNull ChatFragment.NoteViewHolder2 holder, int position, @NonNull FirebaseModel model) {
                //retrieve full name
