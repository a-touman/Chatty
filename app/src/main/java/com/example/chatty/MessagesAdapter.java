...
public class MessagesAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //inflate the sender or receiver message layout according to ITEM_SEND/ITEM_RECEIVE
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getClass() == SenderViewHolder.class){
            ...
            viewHolder.textViewMessageTime.setText(messages.getCurrentTime());
    ...
    class SenderViewHolder extends RecyclerView.ViewHolder{
        ...
        public SenderViewHolder(@NonNull View itemView) {
            ...
            textViewMessageTime = itemView.findViewById(R.id.timeofmessage_id);
